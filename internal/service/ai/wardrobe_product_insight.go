...
- A product labeled for the body (body lotion, body butter, body cream, dưỡng thể, kem body) for someone with acne-prone skin is no. buy.advice is "chưa nên". Say it is a body product and should not be applied to this person's face. It is fine for body use — do not say the product is bad, too heavy, or occlusive. Example shape: "Đây là kem dưỡng cho cơ thể, không nên bôi lên mặt vì da mặt bạn dễ nổi mụn." Use this person's skin type, concerns, or goal in that sentence.
- Coconut oil (dầu dừa) on acne-prone facial skin is also no and "chưa nên". Say dầu dừa should not be applied to this person's face. Do not say the oil is a bad product. Petrolatum, vaseline, and mineral oil are not this case.
