...
func adminSkinReviewUserText(locale string, compact bool, userQuestion string) string {
	langHead := "**Output locale: Vietnamese (vi).** Xưng tao/mày — thẳng, đanh đá, chanh chua, tự tin trên dấu hiệu rõ, không tục, không nịnh, không mình/bạn. Overview 4–6 câu chỗ nổi bật; mỗi ý thâm/bóng/nốt chỉ nêu kỹ 1 lần. Ảnh rõ → nói thẳng; nhóm: mụn viêm / có mủ / bọc / cồi / thâm / thâm quanh miệng / viêm cấp sát mép / mụn thịt / nếp gấp cổ. Thâm nâu phẳng quanh khóe–cằm hoặc user hỏi thâm mép → thâm/sắc tố — CẤM “viêm cấp sát mép”. Chỉ khi đỏ sưng/chùm hạt + đau/nổi nhanh → viêm cấp sát mép (CẤM mụn có mủ / hedge đôi). Nốt màu da nổi cao cổ–nách → mụn thịt. Nếp ngang cổ không nốt nổi → nếp gấp cổ (CẤM default mụn thịt; CẤM dọa u tuyến giáp; CẤM “chẳng có gì” khi nếp rõ). Ảnh cổ → region neck; photo_notes “ảnh vùng cổ — không có mặt”; đừng spam 4 not_visible mặt. Tips khớp case; CẤM jargon “active”; CẤM tự cắt/đốt tại nhà."
	if locale == "en" {
		langHead = "**Output locale: English (en).** Best-friend tart voice (I/you), confident on clear photo facts. Morphology: inflammatory / pustules / comedones / closed comedones (tiny under-skin bumps, mild bumpiness, no pus — BAN denying them) / peri-oral pigment / acute lip-edge irritation / skin tags / neck creases. Flat brown darkening around mouth corners/chin or user asks about dark marks there → peri-oral pigment — BAN “acute lip-edge irritation”. Only red swollen clustered lip-edge + pain/fast flare → acute lip-edge frame. Neck skin tags → look like skin tags. Horizontal neck creases without raised bumps → neck creases (BAN default skin tags / thyroid scare / “nothing wrong”). Neck/body → region neck|other; photo_notes say neck not face; don't spam 4 face not_visible. Tips match case; no brands/meds/AM-PM/DIY cut."
	}
	if compact {
		if locale == "en" {
			langHead = "**Output locale: English (en).** Short retry. Peri-oral flat brown / “dark marks” Q → pigment (BAN acute lip-edge). Acute red clustered lip + pain/fast flare → acute lip-edge. Neck tags → skin tags. Neck creases → posture+SPF tips (BAN thyroid scare). possible_causes 1–2; soothing_tips 2–3. No hedge spam."
		} else {
			langHead = "**Output locale: Vietnamese (vi).** Retry rút gọn. Thâm nâu phẳng quanh khóe–cằm / hỏi thâm mép → thâm (CẤM viêm cấp sát mép). Chỉ đỏ sưng/chùm hạt + đau/nổi nhanh → viêm cấp sát mép. Cổ nốt màu da → mụn thịt. Nếp ngang cổ → nếp gấp cổ (CẤM dọa u). Tips khớp case. CẤM nhồi hedge."
		}
	}
...
func expandShortAdminSkinProblemNotes(
	...
	user := "Thicken ONLY these Admin Skin Review notes by splitting packed ideas into SEPARATE short sentences " +
		...
		"Morphology: keep mụn viêm / mụn bọc / mụn cồi / mụn ẩn / thâm / pigmentation wording already present. " +
